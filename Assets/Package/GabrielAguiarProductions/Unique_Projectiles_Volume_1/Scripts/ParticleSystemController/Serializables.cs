...
namespace GAP_ParticleSystemController
{
    ...
    public class SerializableMinMaxGradient
    {
        ...
        public SerializableMinMaxGradient(ParticleSystem.MinMaxGradient minMaxGradient)
        {
            ...
            {
                gradientMaxAlphaKeys = new SerializableAlphaKeys(
                    minMaxGradient.gradientMax.alphaKeys
                );
                gradientMaxColorKeys = new SerializableColorKeys(
                    minMaxGradient.gradientMax.colorKeys
                );
                gradientMinAlphaKeys = new SerializableAlphaKeys(
                    minMaxGradient.gradientMin.alphaKeys
                );
                gradientMinColorKeys = new SerializableColorKeys(
                    minMaxGradient.gradientMin.colorKeys
                );
            }
        }
